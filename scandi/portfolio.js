(function () {
  ...
  const PORTFOLIO = [
    ...
    { loc: '여주', name: '단독주택 오픈 키친 전체 시공', desc: '높은 층고·전면 통창, 다크 그레이 포세린으로 아일랜드·카운터 통일 시공', cap: '주방아일랜드 · 2026.05', sub: '포세린 · 다크 그레이', img: 'https://minha8206.github.io/eunsung-homepage/images/cases/yeoju/01.webp' },
    ...
    { loc: '남양주', name: '신축 아파트 포세린 주방 시공', desc: '크림 화이트 포세린, 카운터·상부 선반 통일 시공, 빌트인 컷아웃 포함', cap: '주방아일랜드 · 2026.06', sub: '포세린 · 크림 화이트', img: 'https://minha8206.github.io/eunsung-homepage/images/cases/namyangju/01.webp' },
