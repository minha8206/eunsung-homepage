...
window.I18N_EN = {
  ...
  "성수 — 크림 베이지 그랜드 아일랜드": "Seongsu — Grand Island in Cream Beige",
  "여주 — 다크 그레이 오픈 주방": "Yeoju — Open Kitchen in Dark Grey",
  "도곡 — 창가의 화이트 마블 주방": "Dogok — White Marble by the Window",
  "마포 — 하루 만에 끝낸 상판 교체": "Mapo — One-Day Countertop Renewal",
  "남양주 — 크림 화이트 입주 주방": "Namyangju — Cream White, Move-in Ready",
  "홍대 — 벽부터 상판까지 화이트 마블": "Hongdae — White Marble, Wall to Counter",
  "분당 — 크림 마블 ㄱ자 주방": "Bundang — Cream Marble L-Kitchen",
  "춘천 — 월넛 도어에 칼라카타 상판": "Chuncheon — Walnut and Calacatta",
  "판교 — 싱크 일체형 그라파이트 아일랜드": "Pangyo — Graphite Island, Sink Integrated",
  "광교 — 북매칭으로 결을 이은 마블 주방": "Gwanggyo — Bookmatched Marble Kitchen",
  "하남 — 반도형 화이트 마블 주방": "Hanam — White Marble Peninsula",
  "김포 — 퓨어 화이트 ㄷ자 주방": "Gimpo — Compact Kitchen in Pure White",
  "별내 — 세이지 그린 도어에 스톤 상판": "Byeollae — Sage Green with Stone Top",
  "일산 — 블랙 마블 세면대": "Ilsan — Black Marble Vanity",
  "과천 — 세면볼 일체형 카운터": "Gwacheon — Monolithic Basin Counter",
  "다산 — 2구 세면대 상판": "Dasan — Twin Basin Vanity",
  "삼송 — 마블로 감싼 욕실": "Samsong — Marble Bath Surround",
  "운정 — 바닥부터 천장까지 마블 벽": "Unjeong — Marble Walls, Floor to Ceiling",
  "위례 — 벽과 기둥을 감싼 스톤 마감": "Wirye — Stone-Clad Wall and Column",
  "청라 — 트래버틴 서비스 카운터": "Cheongna — Travertine Service Counter",
  "동탄 — 화이트 회의실 테이블": "Dongtan — Boardroom Table in White",
  /* ───────── 플로팅 문의 위젯 ─────────
