...
export default async (req) => {
  ...
  if (code) {
    ...
    try {
      ...
      console.error('[kakao-auth] exchange failed:', e);
      return html(`<h1>토큰 발급 실패</h1><p><code>${escapeHtml(e.message || e)}</code></p><p>Kakao Developers 의 Redirect URI, REST API 키, Client Secret 설정을 확인한 뒤 다시 시도하세요.</p>`, 500);
    }
  }
